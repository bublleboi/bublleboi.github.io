...
(function() {
    ...
    function At() {
        ...
        if (P(t, HTMLScriptElement) && e.test(t.src))
            return t;
        for (var a = document.querySelectorAll("script"), o = 0, c; c = a[o]; o++)
            if (P(c, HTMLScriptElement) && e.test(c.src))
                return c
    }
    function pr() {
        var e = At();
    ...
    function Tr(e, t) {
        ...
        if (o !== null && P(o, HTMLInputElement) && (o.value = t),
        ...
        var e = function(n, i, r, u) {
          ...
          , T = function(n, i) {
            ...
            if (typeof n == "string")
                ...
                P(n, HTMLElement) ? m = n : g('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
            var E = !0
              , S = !1
              , I = void 0;
            try {
            ...
            var V = qr(m);
            if (V) {
                var f = Object.assign(V, i), he = f.action, re = f.cData, ke = f.chlPageData, H = f.sitekey, ae;
                ...
                typeof H != "string" && g('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof H == "undefined" ? "undefined" : F(H), '"'), 3588),
                Kt(H) || g('Invalid input for parameter "sitekey", got "'.concat(H, '"'), 3589),
                ...
                if (!(!Ae || !pe)) {
                    ...
                    j.setAttribute("src", Rt(Ae, H, f, K, !1, "g", z.New, _t(et))),
                    j.onerror = function() {
                        if (Y) {
                    ...
                    j.setAttribute("allow", Ut.join("; ")),
                    j.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
                    j.id = pe;
                    var rt;
                    j.tabIndex = (rt = f.tabindex) !== null && rt !== void 0 ? rt : 0,
                    ...
                    if (Ar) {
                        ...
                        fe.appendChild(Me),
                        typeof f["response-field-name"] != "string" && Rr(H)) {
        ...
        function O() {
            return O = qt(function(b, n, i, r) {
                ...
                return Ve(this, function(V) {
                    ...
                    case 2:
                        return B = V.sent(),
                        B.status !== 200 ? (x("Cannot determine Turnstile's embedded location, aborting clearance redemption, are you running Turnstile on a Cloudflare Zone?"),
                        a(b, n, !1)) : a(b, n, !0),
                        [3, 4];
                    case 3:
                        return te = V.sent(),
                        ...
                        case "fail":
                            {
                                ...
                                if (D) {
                                    var f;
                                    D(String((f = n.code) !== null && f !== void 0 ? f : Qt)) ? r.params.retry === ve.Auto && !r.isResetting && t(r, i, B) : (n.code && x("Error: ".concat(n.code, ".")),
                                    t(r, i, B))
                                } else
                                    n.code ? (t(r, i, B),
    ...
    G = C.params.get("onload"),
    G && !ge && setTimeout(function() {
        typeof window[G] == "function" ? window[G]() : (x("Unable to find onload callback '".concat(G, "' immediately after loading, expected 'function', got '").concat(F(window[G]), "'.")),
        setTimeout(function() {
    ...
    window.turnstile = Dt,
    ge || ((C == null || ($e = C.params) === null || $e === void 0 ? void 0 : $e.get("render")) !== "explicit" && Pt.push(Ft),
